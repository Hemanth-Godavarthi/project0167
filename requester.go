...
func (r *Requester) ExtractInformation() {
	...
	// extract the name
	Name := doc.Find("strong[class='_873b']").Text()
	// extract the image
	Image := doc.Find("img[class='img _99ny l img _1-yc _2sxw']").AttrOr("src", "NO IMAGE")
	...
	EmailsOrPhones := []string{}
	doc.Find("div[class='_52jc _52j9']").Each(func(i int, s *goquery.Selection) {
